...
class ChartController extends Controller
{
    public function pendidikan()
    {
        ...
        $pendidikan = DB::table('t_kartu_keluarga_anggota as t1')
        ...
        // Total keseluruhan
        $totalPenduduk = $pendidikan->count();

        return view('admin.chart.pendidikan.pendidikan', compact('statistik', 'totalPenduduk'));
    }
