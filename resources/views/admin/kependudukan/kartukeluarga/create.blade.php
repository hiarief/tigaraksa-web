        ...
        <div class="col-md-12">
            <div class="card card-dark card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Input Kartu Keluarga</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('kependudukan.kartu.keluarga.store') }}" method="POST"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_kk" id="no_kk" value="{{ old('no_kk') }}"
                                        ...
                                        placeholder="Masukkan 16 digit NKK" title="NKK harus 16 digit angka"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="provinsi_display"
                                        class="form-control form-control-sm text-uppercase" value="BANTEN" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kabkot_display"
                                        class="form-control form-control-sm text-uppercase" value="KABUPATEN TANGERANG"
                                        disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="kecamatan_display"
                                        class="form-control form-control-sm text-uppercase" value="TIGARAKSA" disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="desa_display"
                                        ...
                                        value="{{ auth()->user()->namadesa }}" disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kp" id="kp" value="{{ old('kp') }}"
                                        class="form-control form-control-sm text-uppercase @error('kp') is-invalid @enderror"
                                        placeholder="Contoh: KP. BOJONG" required>
                                    @error('kp')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="rt" id="rt"
                                        class="form-control form-control-sm @error('rt') is-invalid @enderror" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="rw" id="rw"
                                        class="form-control form-control-sm @error('rw') is-invalid @enderror" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pendidikan_non" id="pendidikan_non"
                                        ...
                                        <option value="Pesantren Salafiah"
                                            {{ old('pendidikan_non') == 'Pesantren Salafiah' ? 'selected' : '' }}>Pesantren
                                            Salafiah</option>
                                        <option value="Pendidikan keagamaan Lainnya"
                                            {{ old('pendidikan_non') == 'Pendidikan keagamaan Lainnya' ? 'selected' : '' }}>
                                            Pendidikan Keagamaan Lainnya</option>
                                        <option value="Pendidikan Lainnya"
                                            {{ old('pendidikan_non') == 'Pendidikan Lainnya' ? 'selected' : '' }}>
                                            Pendidikan Lainnya</option>
                                        <option value="Tidak Ada"
                                            {{ old('pendidikan_non') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="pendapatan_perbulan" id="pendapatan_perbulan"
                                        ...
                                        <option value="0-1 Juta"
                                            {{ old('pendapatan_perbulan') == '0-1 Juta' ? 'selected' : '' }}>0 - 1 Juta
                                        </option>
                                        <option value="1-2 Juta"
                                            {{ old('pendapatan_perbulan') == '1-2 Juta' ? 'selected' : '' }}>1 Juta - 2
                                            Juta</option>
                                        <option value="2-3 Juta"
                                            {{ old('pendapatan_perbulan') == '2-3 Juta' ? 'selected' : '' }}>2 Juta - 3
                                            Juta</option>
                                        <option value="3-5 Juta"
                                            {{ old('pendapatan_perbulan') == '3-5 Juta' ? 'selected' : '' }}>3 Juta - 5
                                            Juta</option>
                                        <option value="5-10 Juta"
                                            {{ old('pendapatan_perbulan') == '5-10 Juta' ? 'selected' : '' }}>5 Juta - 10
                                            Juta</option>
                                        <option value="10-20 Juta"
                                            {{ old('pendapatan_perbulan') == '10-20 Juta' ? 'selected' : '' }}>10 Juta - 20
                                            Juta</option>
                                        <option value="20-50 Juta"
                                            {{ old('pendapatan_perbulan') == '20-50 Juta' ? 'selected' : '' }}>20 Juta - 50
                                            Juta</option>
                                        <option value="50-100 Juta"
                                            {{ old('pendapatan_perbulan') == '50-100 Juta' ? 'selected' : '' }}>50 Juta -
                                            100 Juta</option>
                                        <option value=">100 Juta"
                                            {{ old('pendapatan_perbulan') == '>100 Juta' ? 'selected' : '' }}>Lebih dari
                                            100 Juta</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sts_perkawinan" id="sts_perkawinan"
                                        ...
                                        <option value="BELUM KAWIN"
                                            {{ old('sts_perkawinan') == 'BELUM KAWIN' ? 'selected' : '' }}>BELUM KAWIN
                                        </option>
                                        <option value="KAWIN" {{ old('sts_perkawinan') == 'KAWIN' ? 'selected' : '' }}>
                                            KAWIN</option>
                                        <option value="CERAI HIDUP"
                                            {{ old('sts_perkawinan') == 'CERAI HIDUP' ? 'selected' : '' }}>CERAI HIDUP
                                        </option>
                                        <option value="CERAI MATI"
                                            {{ old('sts_perkawinan') == 'CERAI MATI' ? 'selected' : '' }}>CERAI MATI
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_kawin_tercatat" id="status_kawin_tercatat"
                                        ...
                                        <option value="kawin_tercatat"
                                            {{ old('status_kawin_tercatat') == 'kawin_tercatat' ? 'selected' : '' }}>Kawin
                                            Tercatat</option>
                                        <option value="kawin_tidak_tercatat"
                                            {{ old('status_kawin_tercatat') == 'kawin_tidak_tercatat' ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kepemilikan_rumah" id="kepemilikan_rumah"
                                        ...
                                        <option value="Milik Sendiri"
                                            {{ old('kepemilikan_rumah') == 'Milik Sendiri' ? 'selected' : '' }}>Milik
                                            Sendiri</option>
                                        <option value="Orang Tua"
                                            {{ old('kepemilikan_rumah') == 'Orang Tua' ? 'selected' : '' }}>Orang Tua
                                        </option>
                                        <option value="Ngontrak"
                                            {{ old('kepemilikan_rumah') == 'Ngontrak' ? 'selected' : '' }}>Ngontrak
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tanya_bantuanpemerintah" id="tanya_bantuanpemerintah"
                                        ...
                                        <option value="Tidak Layak"
                                            {{ old('tanya_bantuanpemerintah') == 'Tidak Layak' ? 'selected' : '' }}>Tidak
                                            Layak</option>
                                        <option value="Layak"
                                            {{ old('tanya_bantuanpemerintah') == 'Layak' ? 'selected' : '' }}>Layak
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bantuan_pemerintah" id="bantuan_pemerintah"
                                        ...
                                        @foreach ($bantuanPemerintah as $id => $nama)
                                            <option value="{{ $id }}"
                                                {{ old('bantuan_pemerintah') == $id ? 'selected' : '' }}>
                                                {{ $nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="punya_bpjs" id="punya_bpjs"
                                        ...
                                        required>
                                        <option value="" hidden>Pilih Status</option>
                                        <option value="tidak" {{ old('punya_bpjs') == 'tidak' ? 'selected' : '' }}>Tidak
                                        </option>
                                        <option value="ya" {{ old('punya_bpjs') == 'ya' ? 'selected' : '' }}>Ya
                                        </option>
                                    </select>
                                    @error('punya_bpjs')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_bpjs" id="jenis_bpjs"
                                        ...
                                        <option value="bpjs_kesehatan"
                                            {{ old('jenis_bpjs') == 'bpjs_kesehatan' ? 'selected' : '' }}>BPJS Kesehatan
                                        </option>
                                        <option value="bpjs_ketenagakerjaan"
                                            {{ old('jenis_bpjs') == 'bpjs_ketenagakerjaan' ? 'selected' : '' }}>BPJS
                                            Ketenagakerjaan</option>
                                        <option value="memiliki_kedua_bpjs"
                                            {{ old('jenis_bpjs') == 'memiliki_kedua_bpjs' ? 'selected' : '' }}>Memiliki
                                            Kedua BPJS</option>
                                    </select>
                                    @error('jenis_bpjs')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pembayaran_bpjs" id="pembayaran_bpjs"
                                        ...
                                        <option value="mandiri"
                                            {{ old('pembayaran_bpjs') == 'mandiri' ? 'selected' : '' }}>Mandiri</option>
                                        <option value="pemerintah"
                                            {{ old('pembayaran_bpjs') == 'pemerintah' ? 'selected' : '' }}>Pemerintah /
                                            Perusahaan</option>
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nm_ibu" id="nm_ibu" value="{{ old('nm_ibu') }}"
        ...
        $(document).ready(function() {
            ...
            $('#no_kk').on('input', function() {
                ...
                if (nkk.length === 16 && /^\d{16}$/.test(nkk)) {
                    ...
                    feedback.text('NKK harus 16 digit angka').removeClass('text-success').addClass(
                        'text-danger');
                } else {
                    feedback.text('');
                }
