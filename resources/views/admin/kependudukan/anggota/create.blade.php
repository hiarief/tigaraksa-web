...
@section('title', 'Input Data Anggota Keluarga')
@section('content')
        ...
        <div class="col-md-12">
            <div class="card card-dark card-outline">
                <div class="card-header">
                    <h3 class="card-title">Form Input Anggota Keluarga</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('kependudukan.anggota.keluarga.store') }}" method="POST"
                        enctype="multipart/form-data" autocomplete="off" id="formKK">
                        @csrf

                        <div class="bg-gradient-dark mb-3 rounded px-3 py-2">
                            <h6 class="mb-0 text-white"><i class="fas fa-id-card mr-2"></i>PILIH KEPALA KELUARGA</h6>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="fom-group">
                                    ...
                                    <input id="nama" type="text" class="form-control form-control-sm text-sm"
                                        name="namakk" style="text-transform:uppercase" value="{{ old('namakk') }}" required
                                        readonly>
                        ...
                        <div class="bg-gradient-dark mb-3 mt-4 rounded px-3 py-2">
                            <h6 class="mb-0 text-white"><i class="fas fa-map-marker-alt mr-2"></i>ALAMAT KARTU KELUARGA
                            </h6>
                        </div>
                        <div class="row">
                            <div class="col-md">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-sm"
                                        style="text-transform:uppercase" name="desa" value="{{ old('desa') }}"
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm text-sm"
                                        style="text-transform:uppercase" name="kp" value="{{ old('kp') }}"
                                        id="kp" required readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm text-sm"
                                                ...
                                                value="{{ old('rt') }}" id="rt" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm text-sm"
                                                ...
                                                value="{{ old('rw') }}" id="rw" readonly required>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Destroy DataTable saat modal ditutup (opsional)
